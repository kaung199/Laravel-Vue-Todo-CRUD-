   ...
   <div class="w-50">
       <form @submit.prevent="saveData">
            <div class="input-group mb-3 w-100">
                <input v-model="form.title" :class="{ 'is-invalid' : form.errors.has('title') }" name="title" type="text" class="form-control form-control-lg"  aria-label="Recipient's username" aria-describedby="button-addon2">
        ...
        <div class="w-100 todo">
            <div v-for="todo in todos" :key="todo.id" class="w-100 d-flex align-items-center p-3 bg-white border-bottom">
                ...
                <div class="font-weight-bolder">
                    ...
                    <input v-if="editmode == todo.id"   v-model="todo.title" v-on:keyup.13="updateTodo(todo)" type="text">
                </div>
